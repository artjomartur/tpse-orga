...
export default function StudentSpecPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold text-slate-900">Spezifikationsdokument</h1>
        <p className="mt-1 text-sm text-slate-600">PDF hochladen – der Text wird auf der Seite lesbar dargestellt.</p>
      </div>
